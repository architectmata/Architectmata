export const nav=[['Home','/'],['About','/about'],['Books','/books'],['Journal','/journal'],['Travel','/travel'],['Architecture','/architecture'],['Art Classes','/art-classes'],['Explorer Club','/explorer-club'],['Blog','/blog'],['Resources','/resources'],['Contact','/contact']] as const;
