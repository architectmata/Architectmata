...
import { getBookLibraryContent } from "@/lib/cms/fallback-content";
...
export default async function ReadPage() {
  const { books, unavailable } = await getBookLibraryContent();
  return <main className="read-page min-h-screen bg-plaster text-teak dark:bg-[#12150f] dark:text-plaster">
    ...
    <ReadLibrary books={books} unavailable={unavailable}/>
  </main>;
}
